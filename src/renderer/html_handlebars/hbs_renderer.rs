...
fn add_playground_pre(
    ...
    ADD_PLAYGROUND_PRE
        .replace_all(html, |caps: &Captures<'_>| {
            ...
            // Iteration over playground_config.languages
            for language in playground_config.languages.iter() {
                let lang_class = format!("language-{}", language);
...
fn add_playground_pre_rust(
        ...
        || classes.contains("mdbook-runnable")
    {
        ...
        format!("<code class=\"{}\">{}</code>", classes, code)
    }
}
